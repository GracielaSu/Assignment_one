...
<body>
    <div
        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
            <p class="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-gray-300">Let's</p>
            <p class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-300 mt-2">Go Shopping!</p>
            <p class="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">Check out the latest prices online at Let's Go Shopping!</p>
            <a href="/wedding"
